      ...
      <section className="grid min-h-screen w-full md:grid-cols-2">
        <aside className="hidden bg-primary text-white md:flex md:items-start md:justify-center md:p-14 lg:p-16">
          <div className="mt-32 max-w-md text-start">
            ...
            <p
              className={`${poppins.className} mt-5 text-[14px] leading-[22px] font-semibold text-on-primary-muted`}
            >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                <Button
                  ...
                  className={`${poppins.className} h-auto rounded-lg bg-[var(--success)] px-3 py-2 text-[13px] leading-[20px] font-semibold text-white hover:bg-[var(--success)]/90`}
                >
                  Success Toast
                </Button>
                <Button
                ...
                <Button
                  ...
                  className={`${poppins.className} h-auto rounded-lg bg-[var(--danger)] px-3 py-2 text-[13px] leading-[20px] font-semibold text-white hover:bg-[var(--danger)]/90`}
                >
                  Error Toast
                </Button>
              </div>
